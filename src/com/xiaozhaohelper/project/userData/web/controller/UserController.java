...
public class UserController {
	...
	public String login(Model model,
		...
		if (userInformation != null
				&& userInformation.getStatus() == userInformation.STATUS_ACTIVATE
	...
	public String getUserDetailInformation(Model model,
			@PathVariable("userID") String userID) {

		model.addAttribute("userInformation",
				userInformationService.getByPK(userID));
		return "/user/detail";
	}
	 ...
	 * @return
	 */
	public String updateUserStatus(UserInformation userInformation, int status) {

		if (status == UserInformation.STATUS_ACTIVATE) {
			userInformation.setStatus(userInformation.STATUS_ACTIVATE);
			userInformationService.update(userInformation);
			return "/activateSuccess";
		}
		else {
			userInformation.setStatus(userInformation.STATUS_FORBIDDEN);
			userInformationService.update(userInformation);
			return "/forbinddenSuccess";
		}
	}
	...
	public String changePasswordSuccess(UserInformation userInformation,
			String password) {
